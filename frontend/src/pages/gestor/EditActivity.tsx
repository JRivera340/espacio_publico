            ...
            {enGrupo && (
              <fieldset className="space-y-2">
                ...
                {!errorGestores && posiblesAcompanantes.length === 0 && (
                  <p className="text-xs text-neutral-500">No hay otros gestores del area para seleccionar.</p>
                )}
                <div className="flex flex-wrap gap-2">
                        ...
                        <input
                          ...
                          onChange={() =>
                            setGestoresSeleccionados((previos) =>
                              marcado ? previos.filter((idGestor) => idGestor !== gestor.id) : [...previos, gestor.id],
                            )
                          }
                          className="w-3.5 h-3.5"
                        />
