...
// Iconos minimos que usa el armazon de este modulo. Si una pantalla nueva
// necesita un icono que no esta aca, se agrega a este set - no se crea un set
// paralelo.
export type NavIconName = 'home' | 'route' | 'user' | 'logout' | 'chevron-left' | 'chevron-right';
