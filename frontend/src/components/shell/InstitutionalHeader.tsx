...
export const InstitutionalHeader: React.FC<InstitutionalHeaderProps> = ({ email, onCerrarSesion }) => (
  <header
    className="header-sweep relative overflow-hidden shrink-0 flex items-center justify-between px-4 py-3.5 z-[1700] shadow-lg"
    style={{
      background:
    ...
    <div className="relative z-10 flex items-center gap-3 min-w-0">
      ...
      <div className="min-w-0 border-l border-white/25 pl-3">
        <h1
          ...
          style={{ fontFamily: 'Archivo, sans-serif', fontStretch: '92%' }}
        >
          Espacio Publico
        </h1>
